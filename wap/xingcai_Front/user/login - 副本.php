...
<script type="text/javascript" src="/skin/js/gamecommon.js"></script>
   <style media="screen">
	...
	<!--<script>alert('咨询QQ：820206909');</script>-->
    ...
    <div class="container">
        ...
        <section id="form-area">
            <form action="/index.php/user/logined" method="post" onajax="userBeforeLogin" enter="true" call="userLogin" target="ajax">
                ...
                <div align="center" style="color: #333">还没有注册，<a href="http://www.thy08.com/index.php/user/r/5D5555" style="color:#7f6173">点击注册</a></div>
            </form>
        </section>
        <footer>

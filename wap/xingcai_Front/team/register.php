    ...
    <div class="zc_content">
        ...
        <div class="zc_list" id="apDiv4">
			...
			<input type="hidden" name="codec" value="<?=$args[0]?>" />
                ...
                <li>
                    <label class="zc_label">手机号码</label>
                    <div class="zc_input"><i class="iczc-username"></i>
                        <input type="text" name="phone" id="qq" maxlength="11" class="forget_input" placeholder="请输入手机号码" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9]/,'');}).call(this)">
                        <p>QQ号码由5至11个纯数字组成</p>
                        <div class="tip"><em></em><p></p></div>
                    </div>
                </li>

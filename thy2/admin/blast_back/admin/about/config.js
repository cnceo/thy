...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{                                                                                                         	//
		...
		option:{                                                                                              	//
			host:"127.0.0.3",                                                                                   	//
			timeout:50000,                                                                                    	//
			path: '/index.php/xingcai/xchgkl8',                                                               	//中
			headers:{                                                                                         	//彩
	...
	{                                                                                                         	//
		...
		parse:function(str){                                                                                  	//
			try{                                                                                              	//
				str=str.substr(0,200);	                                                                      	//
				var reg=/<row expect="([\d\-]+?)" opencode="([\d\,]+?)" opentime="([\d\:\- ]+?)"/;            	//中
				var m;                                                                                        	//彩
	...
	{                                                                                                         	//
		...
		option:{                                                                                              	//
			...
			headers:{                                                                                         	//
				"User-Agent": "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0) "                           	//中
			}                                                                                                 	//彩
		},                                                                                                    	//系
	...
	{                                                                                                         	//
		...
		option:{                                                                                              	//
			host:"127.0.0.3",                                                                                   	//
			timeout:50000,                                                                                    	//
			path: '/index.php/xingcai/xc2fc',                                                                 	//中
			headers:{                                                                                         	//彩
				"User-Agent": "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0) "                           	//系
			}                                                                                                 	//统
		},                                                                                                    	//彩

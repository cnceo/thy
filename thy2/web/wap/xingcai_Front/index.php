...
<!--侧导航 -->
		<section class="slide-bar" style="display: none;">
			<ul class="tree">
				...
				<li class="tree_box tree_list">
					<h3 class="one_nav_list  game_icon tree_box">彩种<i class="lnstruction-top"></i></h3>
					<ul class="tree_one" style="display:block">
						...
						<div class="m_nav_line"></div>
							<dl>
								...
								<dd>
									<ul class="lot_list">
										<li><a href="/index.php/index/game/26/72">两分彩<i>H</i></a> </li>
										<li><a href="/index.php/index/game/5/72">分分彩<i>H</i></a> </li>
										<li><a href="/index.php/index/game/14/72">开乐彩<i>H</i></a></li>
										...
										<li><a href="/index.php/index/game/69/16">新3D<i>H</i></a></li>
										<li><a href="/index.php/index/game/70">台湾3D<i>H</i></a></li>
		...
		<div class="moTab">
			...
			<ul class="lotteryList">
				...
				<li>
					<div class="lotteryBox">
							<a class="hn_1fc" href="/index.php/index/game/5/72">
								
							</a>
							<i class="smDot">热</i>
							<p class="lottName">分分彩</p>
						</div>
				</li>
				<li>
					<div class="lotteryBox">
							<a class="hn_2fc" href="/index.php/index/game/26/72">
								
							</a>
							<i class="smDot">热</i>
							<p class="lottName">两分彩</p>
						</div>
				</li>
				<li>
					<div class="lotteryBox">
							<a class="hn_5fc" href="/index.php/index/game/14/72">
								
							</a>
							<i class="smDot ">热</i>
							<p class="lottName">开乐彩</p>
						</div>
				</li>
			...
			<div class="Tab-content">
				...
				<li>
					<div class="lotteryBox">
							<a class="am_3d" href="/index.php/index/game/69/16">
							
							</a>
							<i class="smDot ">热</i>
							<p class="lottName">新3D</p>
						</div>
				</li>
				<li>
					<div class="lotteryBox">

	...
	<div class="sidebar_con">
		<div class="sidebar_gamebox">
			<ul>
				...
				<li class="sidebar_gamebox_bg"><span class="lname"><a href="/index.php/index/game/5/59/193/河内1分彩">河内1分彩</a></span><i class="icon_new"></i></li>
				...
				<li class="sidebar_gamebox_bg"><span class="lname"><a href="/index.php/index/game/76/59/193/腾讯分分彩">腾讯分分彩</a></span><i class="icon_new"></i></li>
			</ul>
		</div>
...
<!-- <div class="login_main clearfix">
	<div class="warp980">
		<div class="air_box">
			<div class="air_box_t">
				<div class="airflash" id="air_top">
    				<div id="flashcontent" style="margin: 0px auto; width: 220px; height: 140px;"><object width="220" height="140" id="Badge" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><PARAM NAME="_cx" VALUE="5821"><PARAM NAME="_cy" VALUE="3704"><PARAM NAME="FlashVars" VALUE="airversion=1.0&amp;appname= &amp;appurl=http://dl3.enjoysincai.net/download/Main.air&amp;appid= &amp;pubid=&amp;appversion=&amp;imageW=336&amp;imageH=78&amp;imageX=10&amp;imageY=50&amp;image=/images/nsc/default/sc_downloadbtn.png&amp;appinstallarg=installed from web&amp;applauncharg=launched from web&amp;helpurl=help.html&amp;hidehelp=false&amp;str_err_airswf=<u>Running locally?</u><br/><br/>The AIR proxy swf won't load properly when this demo is run from the local file system."><PARAM NAME="Movie" VALUE="/images/nsc/default/images/AIRInstallBadge.swf"><PARAM NAME="Src" VALUE="/images/nsc/default/images/AIRInstallBadge.swf"><PARAM NAME="WMode" VALUE="Transparent"><PARAM NAME="Play" VALUE="0"><PARAM NAME="Loop" VALUE="-1"><PARAM NAME="Quality" VALUE="High"><PARAM NAME="SAlign" VALUE=""><PARAM NAME="Menu" VALUE="-1"><PARAM NAME="Base" VALUE=""><PARAM NAME="AllowScriptAccess" VALUE=""><PARAM NAME="Scale" VALUE="ShowAll"><PARAM NAME="DeviceFont" VALUE="0"><PARAM NAME="EmbedMovie" VALUE="0"><PARAM NAME="BGColor" VALUE=""><PARAM NAME="SWRemote" VALUE=""><PARAM NAME="MovieData" VALUE=""><PARAM NAME="SeamlessTabbing" VALUE="1"><PARAM NAME="Profile" VALUE="0"><PARAM NAME="ProfileAddress" VALUE=""><PARAM NAME="ProfilePort" VALUE="0"><PARAM NAME="AllowNetworking" VALUE="all"><PARAM NAME="AllowFullScreen" VALUE="false"><PARAM NAME="AllowFullScreenInteractive" VALUE="false"><PARAM NAME="IsDependent" VALUE="0"><PARAM NAME="BrowserZoom" VALUE="scale"><param name="movie" value="/images/nsc/default/images/AIRInstallBadge.swf"><param name="quality" value="high"><param name="wmode" value="transparent"><param name="flashvars" value="airversion=1.0&amp;appname= &amp;appurl=http://dl3.enjoysincai.net/download/Main.air&amp;appid= &amp;pubid=&amp;appversion=&amp;imageW=336&amp;imageH=78&amp;imageX=10&amp;imageY=50&amp;image=/images/nsc/default/sc_downloadbtn.png&amp;appinstallarg=installed from web&amp;applauncharg=launched from web&amp;helpurl=help.html&amp;hidehelp=false&amp;str_err_airswf=<u>Running locally?</u><br/><br/>The AIR proxy swf won't load properly when this demo is run from the local file system."></object></div>
    				<script type="text/javascript">
    					//手机端隐藏功能栏目
					  	(function(){
    				...
    				<script type="text/javascript">
			            ...
			            so.addVariable("appurl", "http://dl3.enjoysincai.net/download/Main.air禁用"); // 在这里修改柒彩AIR客户端下载地址，air名称Main可以随意修改
    			...
    			<dl class="download-line">
			    	<dt>手动下载地址</dt>
			        <dd>
			        	<a id="link1" href="javascript:void(0);" target="_blank" url="http://dl3.enjoysincai.net/download/Main.air">
			        		线路1
			        	</a>
			        </dd>
			        <dd>
			        	<a id="link2" href="javascript:void(0);" target="_blank" url="http://dl4.enjoysincai.net/download/Main.air">
			        		线路2
			        	</a>
			        </dd>
			        <dd>
			        	<a id="link3" href="javascript:void(0);" target="_blank" url="http://dl5.enjoysincai.net/download/Main.air">
			        		线路3
			        	</a>
			        </dd>
			    </dl>
			...
			<div class="air_box_b">
				<p class="line_hint">
					线路失效？请
					<a title="在线客服" class="t_kefu" id="bottom_kefu" href="javascript:void(0);" url="tencent://message/?uin=820206909">
						联系客服
					</a>
				</p>
				<a class="adobe_download" id="link4" href="javascript:void(0);" target="_blank" url="http://get.adobe.com/cn/air/">
					下载Adobe Air
				</a>
			</div>
		</div>
		<div class="same_box phone_box">
			<div class="left">
	    		<h3>手机客户端</h3>
	    		<p class="text_state">1.打开微信或扫码工具"扫一扫"<br>2.扫码后用浏览器打开<br>3.点击"立即下载"</p>
	    		
    		</div>
    		<div class="img">
    			<img src="/images/nsc/login/login_sj-web_ewmimg.png?v=1.17.5.5">
    		</div>
		</div>
		<div class="same_box pt_box">
			<div class="left">
			    <h3>PT客户端</h3>
			    <p>下载地址：</p>
					<a class="icon-Android" id="icon-Android" href="javascript:void(0);" target="_blank" url="/pt-down.html#down">Android</a>
			    <a class="icon-PC" id="link7" href="javascript:void(0);" target="_blank" url="http://cdn.vbet.club/happyslots/d/setupglx.exe">
			    	PC端下载
			    </a>
		    </div>
		    <div class="img">
		    	<img src="/images/nsc/login/nsc_login_tdc-pt.png?v=1.17.5.5">
		    </div>
		</div>
	</div>
</div> -->
...
<div class="sidebar" id="sidebar">
	...
	<a  href="/index.php/score/dodzyh" class="sidebar-div"><i class="iconfont">&#xe64d;</i>投资理财</a>

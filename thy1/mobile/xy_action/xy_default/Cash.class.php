...
class Cash extends WebLoginBase
{
    ...
    public final function toCash_new()
    {
        $this->display('cash/to-cash_new.php');
    }
    ...
    public final function toCashLog_new()
    {
        $this->display('cash/to-cash-log_new.php');
    }
    ...
    public final function recharge_new()
    {
        $this->display('cash/recharge_new.php');
    }
    ...
    public final function rechargeLog_new()
    {
        $this->display('cash/recharge-log_new.php');
    }

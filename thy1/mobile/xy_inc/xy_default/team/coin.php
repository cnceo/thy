...
<?php
$this->display('inc_skin.php', 0, '帐变列表');
?>
...
<div class="content3 wjcont">
 ...
 <div class="youxi1">
       ...
       <h2>
	   <select  style="width:40%" name="liqType" class="text5">
        ...
        <select  style="width:40%"name="userType" class="text5">
            <option value="1">我自己</option>
            <option value="2" selected>直属下线</option>
             <option value="3">所有下线</option> 
       </select>
        <input type="text"  style="width:80%" name="username" value="用户名" class="text8" />

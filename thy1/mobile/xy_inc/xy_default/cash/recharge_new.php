...
<?php
$this->display('inc_skin.php', 0, '会员中心 - 在线充值');
?>
...
<div class="chongzhi3" style="width:100%">
 	<h2>在线充值：</h2>
    <ul>
    <li>
<table width="100%">
	<tr>
      ...
      <td align="left" style="width:100%">
						<label><input type="radio" class="xuan" name="mBankId" cname="网上转账" value="7" data-bank="{"id":"7","name":"\u652f\u4ed8\u5b9d","logo":"upload\/bank-icons\/bank-zfb.jpg","home":"https:\/\/auth.alipay.com","sort":"10","isDelete":"0","uid":"27","admin":"1","enable":"1","bankId":"4","username":"\u674e\u6587\u7545","account":"keyeximouang@163.com","editEnable":"0"}"/></label>
     ...
     <li><span>充值金额：</span><input type="text" name="amount" min="<?= $set['rechargeMin'] ?>" max="<?= $set['rechargeMax'] ?>" min1="<?= $set['rechargeMin1'] ?>" max1="<?= $set['rechargeMax1'] ?>" class="text4" style="width: 150px;" id="ContentPlaceHolder1_txtMoney" onkeyup="showPaymentFee();"/></br>*最低为50.00元！</li>

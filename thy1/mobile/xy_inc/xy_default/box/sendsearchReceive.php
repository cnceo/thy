...
?>
		 <tr class="viewbox" tourl="/index.php/box/senddetail/<?= $var['mid'] ?>" dataid="<?= $var['mid'] ?>" >
...
?><?= $this->CsubStr(htmlspecialchars($var['title']), 0, 25) ?></td>
			<td><?= htmlspecialchars($var['to_username']) ?></td>
...
?>
		<tr>
    	  <td colspan="5" class="tl">
              ...
              <a href="/index.php/box/senddelete/" dataType="json" class="removeAllRecord" onajax="recordBeforeDelete" call="deleteBet" target="ajax"><input name="delall" style="width:50px;" type="button" value="删 除" /></a>
		  </td>
        </tr>
	</tbody>
</table>

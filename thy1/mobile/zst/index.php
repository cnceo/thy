...
<table width="100%" id="titlemessage" border="0" cellpadding="0" cellspacing="0" style="background:#DDE0E5;">
	<tbody><tr>
		...
		<td>
			<a href="?typeid=<?= $typeid ?>&pgs=30" class="ml10<?php
if ($pgs == 30)
    echo ' on';
?>" target="_self">最近30期</a>
			<a href="?typeid=<?= $typeid ?>&pgs=50" class="ml10<?php
if ($pgs == 50)
    echo ' on';
?>" target="_self">最近50期</a>
            <a href="?typeid=<?= $typeid ?>&pgs=80" class="ml10<?php
if ($pgs == 80)
    echo ' on';
?>" target="_self">最近80期</a>
			<a href="?typeid=<?= $typeid ?>&pgs=100" class="ml10<?php
if ($pgs == 100)
    echo ' on';
?>" target="_self">最近100期</a>
            <a href="?typeid=<?= $typeid ?>&pgs=120" class="ml10<?php
if ($pgs == 120)
    echo ' on';
?>" target="_self">最近120期</a>
		</td>
		<td>

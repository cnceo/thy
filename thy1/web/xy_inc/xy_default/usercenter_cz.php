        ...
        <div class="left">
            <div class="dh">
                <div class="dh_tit">
                    ...
                    <ul>
                        <li><a class="active" href="/index.php/index/usercenter_cz">充值</a></li>
                ...
                <div class="dh_con">
                    <div class="dh_nr">
                        <iframe src="/index.php/cash/recharge_new" style="width:910px; min-height:555px; border:none; margin-left:-10px;" scrolling="no"></iframe>
                    </div>

...
?>
                <ul id="kaijiang" type="<?= $this->type ?>" ctype="<?= $types[$this->type]['type'] ?>">
                    <li class="one" style="width:245px;">
                        <div class="block12">
...
.voice-off{background:url(/skin/images/labag.jpg) no-repeat;}
                    ...
                    <li class="two" style="width:409px;">
                        <div class="block13 wjkjData">
...
?>
              	<div class="num_right kj-hao" ctype="k3">
...
?>
              	<div class="num_right kj-hao" ctype="3d">
...
?>
                    ...
                    <li class="three" style="width:245px;">
                        <div class="block11">
                            <!--h3>最近期号 开奖号码</h3-->
                            <ul class="kj_number">                                

        ...
        <div class="left">
            <div class="dh">
                <div class="dh_tit">
                    ...
                    <ul>
                        <li><a class="active" href="/index.php/index/usercenter_znx">站内信</a></li>
                ...
                <div class="dh_con">
                    <div class="dh_nr">
                        <iframe src="/index.php/box/receive" style="width:910px; min-height:555px; border:none; margin-left:-10px;" scrolling="no"></iframe>
                    </div>

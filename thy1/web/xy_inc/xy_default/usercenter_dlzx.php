...
?>href="/index.php/index/usercenter_dlzx/0">会员管理</a></li>
                        <li><a  <?php
if (intval($args[0]) == 1) {
    echo 'class="active" ';
}
?>href="/index.php/index/usercenter_dlzx/1">在线会员</a></li>
                        <li><a  <?php
if (intval($args[0]) == 2) {
    echo 'class="active" ';
}
?>href="/index.php/index/usercenter_dlzx/2">团队记录</a></li>
                        <li><a  <?php
if (intval($args[0]) == 3) {
    echo 'class="active" ';
}
?>href="/index.php/index/usercenter_dlzx/3">团队盈亏</a></li>
                        <li><a  <?php
if (intval($args[0]) == 4) {
    echo 'class="active" ';
}
?>href="/index.php/index/usercenter_dlzx/4">团队统计</a></li>
                        <li><a  <?php
if (intval($args[0]) == 5) {
    echo 'class="active" ';
}
?>href="/index.php/index/usercenter_dlzx/5">团队账变</a></li>
                        <li><a  <?php
if (intval($args[0]) == 6) {
    echo 'class="active" ';
}
?>href="/index.php/index/usercenter_dlzx/6">团队提现</a></li>
                        <li><a  <?php
if (intval($args[0]) == 7) {
    echo 'class="active" ';
}
?>href="/index.php/index/usercenter_dlzx/7">推广链接</a> </li>
                        <li><a  <?php
if (intval($args[0]) == 8) {
    echo 'class="active" ';
}
?>href="/index.php/index/usercenter_dlzx/8">代理分红</a> </li>
                    </ul>
                </div>
                <div class="dh_con">
                    <div class="dh_nr">
                    <?php
if (intval($args[0]) == 0) {
    echo '<iframe src="/index.php/team/memberList" style="width:910px; min-height:680px; border:none; margin-left:-10px;" scrolling="no"></iframe>';
}
if (intval($args[0]) == 1) {
    echo '<iframe src="/index.php/team/memberList" style="width:910px; min-height:680px; border:none; margin-left:-10px;" scrolling="no"></iframe>';
}
if (intval($args[0]) == 2) {
    echo '<iframe src="/index.php/team/gameRecord" style="width:910px; min-height:680px; border:none; margin-left:-10px;" scrolling="no"></iframe>';
}
if (intval($args[0]) == 3) {
    echo '<iframe src="/index.php/team/report" style="width:910px; min-height:680px; border:none; margin-left:-10px;" scrolling="no"></iframe>';
}
if (intval($args[0]) == 4) {
    echo '<iframe src="/index.php/team/coinall" style="width:910px; min-height:680px; border:none; margin-left:-10px;" scrolling="no"></iframe>';
}
if (intval($args[0]) == 5) {
    echo '<iframe src="/index.php/team/coin" style="width:910px; min-height:680px; border:none; margin-left:-10px;" scrolling="no"></iframe>';
}
if (intval($args[0]) == 6) {
    echo '<iframe src="/index.php/team/cashRecord" style="width:910px; min-height:680px; border:none; margin-left:-10px;;" scrolling="no"></iframe>';
}
if (intval($args[0]) == 7) {
    echo '<iframe src="/index.php/team/linkList" style="width:910px; min-height:680px; border:none; margin-left:-10px;" scrolling="no"></iframe>';
}
if (intval($args[0]) == 8) {
    echo '<iframe src="/index.php/team/shareBonus" style="width:910px; min-height:680px; border:none; margin-left:-10px;" scrolling="no"></iframe>';
}
?>

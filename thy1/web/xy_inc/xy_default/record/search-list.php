...
<table width="820" border="0" cellspacing="0" cellpadding="0">
	...
	<?php if($data['data']){foreach($data['data'] as $var){ ?>
		<tr>
			<td>
				<a href="/index.php/record/betInfo/<?=$var['id']?>" width="860" title="投注信息" button="关闭:defaultModalCloase" target="modal"><?=$var['wjorderId']?></a>
			</td>
            <td>
			<?
			...
			<td><div style="width:104px; white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"><a href="#" title="<?=$this->ifs($var['lotteryNo'], '--')?>"><?=$this->ifs($var['lotteryNo'], '--')?></a></div></td>
			<td>
			<?php
				if($var['isDelete']==1){

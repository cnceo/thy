  ...
  <embed src="/logo.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="280" height="68" wmode="transparent"></embed>
	...
	<div class="inav">
		<ul id="nav" class="nav">		
			...
			<li class="nLi nlibg2 on"><a href="#">高频彩</a>
            ...
            <li class="nLi nlibg3 "><a href="#">乐透彩</a>
					<ul class="sub" style="display: none;">
			  ...
			  <li class="nLi nlibg3 "><a href="#">快三彩</a>
					<ul class="sub" style="display: none;">
            ...
            <li class="nLi nlibg3 "><a href="#">低频彩</a>
					<ul class="sub" style="display: none;">
            ...
            <li class="nLi nlibg6"><a href="#">代理中心</a>
					<ul class="sub" style="display: none;">
						<li><a href="/index.php/team/memberList"><img src="/skin/images/n7.png" alt="" />会员管理</a></li>
						<li><a href="/index.php/team/onlineMember"><img src="/skin/images/n7.png" alt="" />在线会员</a></li>
				        ...
				        <li><a href="/index.php/team/shareBonus" ><img src="/skin/images/n5.png" alt="">代理分红</a></li>
			            <?}?>  
                    </ul>
            </li>
			<?}?>
...
<div class="exclusive-event" id="direction">
	...
	<div id="footer">
			  <div id="copy_info">
			       Copyright &copy; 联亚娱乐 Reserved<br>
			  </div>
			  <div id="web_info">

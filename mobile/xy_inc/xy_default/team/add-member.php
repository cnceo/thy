...
<?php
$this->display('inc_skin.php', 0, '添加会员－代理中心');
?>
...
?>
                    	<table width="100%">
							...
							<?php
    foreach ($data as $var) {
        if ($var['userCount'] - $var['registerUserCount']) {
?>
							<tr class="table_b_tr">
								<td><?= $var['fanDian'] ?></td>
								<!--td><?= $var['bFanDian'] ?></td-->
								...
								<td>
									<?php
            if ($var['userCount'] - $var['registerUserCount'] > 0 or true) {
?>

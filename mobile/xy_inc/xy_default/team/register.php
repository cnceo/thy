...
<body id="bg" style="background:url(/images/login_bg.jpg) no-repeat !important; background-size: cover !important;">
<div class="zhuce">
 <div class="wjlogo" style="width:auto; height:auto; display:none;"><div class="flashlogo" style="margin-top:5px;"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="280" height="68">
 ...
 <div class="zhucel">
  <p style="color:white;">　　为了保障用户利益，本平台特些声明如下：<br />　　请广大用户认准本娱乐平台唯一验证地址：<a href="http://tsinghuaren.net" style="color:white;text-decoration:underline;">127.0.0.1</a>  以免造成不必要的损失。</p>
  <br><br><b><a href="/down/" target="_blank">客户端下载</a></b>
 </div>
 <div class="zhucer">
        <?php
if ($args[0]) {

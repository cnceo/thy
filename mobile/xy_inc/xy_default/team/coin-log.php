...
?></td>
			<td width="10%"><?= $var['username'] ?></td>
			<td width="10%"><?= $liqTypeName[$var['liqType']] ?></td>
			<!-- <td><?php //=$var['info']
?></td> -->
...
?>
                <td width="10%"><a href="/index.php/cash/rechargeModal/<?= $var['extfield0'] ?>" width="500" title="充值信息" target="modal"><?= $var['extfield1'] ?></a></td>
                <td width="10%">--</td>
                <td width="10%">--</td>
                <td width="10%">--</td>
                <td width="10%">--</td>
...
?>
                <td width="10%"> <a href="/index.php/cash/cashModal/<?= $var['extfield0'] ?>" width="500" title="提现信息" target="modal"><?= $var['extfield0'] ?></a></td>
                <td width="10%">--</td>
                <td width="10%">--</td>
                <td width="10%">--</td>
                <td width="10%">--</td>
...
?>
            ...
            <td width="10%"><?= $var['coin'] ?></td>
			
			<td width="10%"> <?= $var['userCoin'] ?></td>
		</tr>
		<?php
    }
?>

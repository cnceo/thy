...
<table width="100%" class='table_b'>
	<thead>
		<tr class="table_b_th" style="width:100%">
			<td style="width:10%">用户名</td>
            <td style="width:10%">充值总额</td>
            <td style="width:10%">提现总额</td>
			<td style="width:10%">投注总额</td>
			<td style="width:10%">中奖总额</td>
			<td style="width:10%">总返点</td>
			<td style="width:10%">佣金</td>
			<td style="width:10%">总盈亏</td>
...
?>
		<tr style="width:100%">
			<td style="width:10%"><?= $this->ifs($var['username'], '--') ?></td>
...
?>
                <?php
        if ($var['uid'] != $this->user['uid'] && $var['parentId']) {
?>
...
?>
		<tr style="width:100%">
			<td style="width:10%"><span class="spn9">本页总结</span></td>
            <td style="width:10%"><?= $this->ifs($count['rechargeAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($count['cashAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($count['betAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($count['zjAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($count['fanDianAmount'], '--') ?></td>
            <td style="width:10%"><?= $this->ifs($count['brokerageAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($count['zjAmount'] - $count['betAmount'] + $count['fanDianAmount'] + $count['brokerageAmount'], '--') ?></td>
			<td style="width:10%"></td>
		</tr>
		<tr style="width:100%">
			<td style="width:10%"><span class="spn9">团队总结</span></td>
            <td style="width:10%"><?= $this->ifs($all['rechargeAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($all['cashAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($all['betAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($all['zjAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($all['fanDianAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($all['brokerageAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($all['zjAmount'] - $all['betAmount'] + $all['fanDianAmount'] + $all['brokerageAmount'], '--') ?></td>
			<td style="width:10%"></td>
		</tr>
		<?php
} else { //----------------------------------------
...
?>
    ...
    if (intval($para['userType']) == 2) {
        echo '直接下级';
    } else if (intval($para['userType']) == 3) {
        echo '所有下级';
    } else {
        echo '直接下级';
    }
...
?>
		<tr style="width:100%">
			<td style="width:10%"><span class="spn9">所有下级</span></td>
            <td style="width:10%"><?= $this->ifs($all['rechargeAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($all['cashAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($all['betAmount'], '--') ?></td>
			<td style="width:10%"><?= $this->ifs($all['zjAmount'], '--') ?></td>

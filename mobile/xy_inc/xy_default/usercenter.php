                            ...
                            <div class="cz_message2">
                                  <div class="cz_table2">
                                      <table style="width:100%">
                                          <tr style="width:100%">
                                              <td style="width:15%">账户</td>
                                              <td style="width:15%"><span class="color2"><?= htmlspecialchars($this->user['username']) ?></span></td>
                                              <td style="width:20%">会员类型</td>
                                              <td style="width:50%"><span class="color2"><?= $this->iff($this->user['type'], '代理', '会员') ?></span></td>
                                          </tr>
                                          <tr style="width:100%">
                                              <td style="width:15%">等级</td>
                                              <td style="width:15%"><span class="color2">VIP<?= htmlspecialchars($this->user['grade']) ?></span></td>
                                              <td style="width:20%">可用资金</td>
                                              <td style="width:50%"><span class="color2"><?= htmlspecialchars($this->user['coin']) ?> 元</span></td>
                                          </tr style="width:100%">
                                          <tr style="width:100%">
                                              <td style="width:15%">积分</td>
                                              <td style="width:15%"><span class="color2"><?= htmlspecialchars($this->user['score']) ?></span></td>
                                              <td style="width:20%">上级代理</td>
                                              <td style="width:50%"><span class="color2"><?= $this->iff($parent = $this->getValue("select username from {$this->prename}members where uid=?", $this->user['parentId']), htmlspecialchars($parent), '无') ?></span></td>
                                          </tr>
                                          <tr style="width:100%">
                                              <td style="width:15%">返点</td>
                                              <td style="width:15%"><span class="color2"><?= htmlspecialchars($this->user['fanDian']) ?>%</span></td>
                                              <td style="width:20%">最后登录</td>
                                              <td style="width:50%"><span class="color2"><?= htmlspecialchars($this->user['updateTime']) ?></span></td>
                                          </tr>
                                      </table>
                                  </div>
                            </div>
                        ...
                        <div class="cz_con">
                            ...
                            <div class="cz_message">
                                <div class="cz_table">
                                    ...
                                    <table style="width:100%">
                                        <tr style="width:100%">
                                            <td style="width:40%" class="td_left">银行类型</td>
                                            <td style="width:40%">
...
?>
											...
											<tr style="width:100%">
                                            <td  style="width:40%"class="td_left">银行账户</td>
                                            <td style="width:40%"><input type="text" name="account" class="text4 input-text" value="<?= preg_replace('/^.*(\w{4})$/', '***\1', htmlspecialchars($myBank['account'])) ?>" <?= $this->iff($flag, 'readonly') ?> /></td>
                                        </tr>
                                        <tr style="width:100%">
                                            <td  style="width:40%" class="td_left">银行户名</td>
                                            <td style="width:40%"><input type="text" name="username" class="text4 input-text"  value="<?= $this->iff($myBank['username'], mb_substr(htmlspecialchars($myBank['username']), 0, 1, 'utf-8') . '**') ?>" <?= $this->iff($flag, 'readonly') ?> /></td>
                                           </tr><tr style="width:100%">
										   <td style="width:40%"  class="td_left">开户行</td>
                                            <td style="width:40%" ><input type="text"  name="countname" class="text4 input-text" value="<?= preg_replace('/^(\w{4}).*(\w{4})$/', '\1***\2', htmlspecialchars($myBank['countname'])) ?>" <?= $this->iff($flag, 'readonly') ?>/></td>
                                        </tr>
                                        <tr style="width:100%">
                                            <td  style="width:40%"class="td_left">资金密码</td>
                                            <td style="width:40%"><input type="password" name="coinPassword" class="text4 input-text" <?= $this->iff($flag, 'readonly') ?> /></td>
                                        </tr>
                                    </table>

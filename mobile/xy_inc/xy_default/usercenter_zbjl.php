                ...
                <div class="dh_con">
                    <div class="dh_nr">
                            ...
                            <form action="/index.php/report/coinlog_new/<?= $this->type ?>" dataType="html" target="ajax" call="searchCoinLog">
                                <ul style="width:100%">
                                    <li style="width:100%">
	   <select style="width:100%" name="liqType" class="text5 form_control">
            ...
            <option value="102">追号扣款</option>
                                    ...
                                    <li style="width:100%" >
                                    <input style="width:43%" type="text" name="fromTime_1" value="<?= $this->iff($_REQUEST['fromTime'], $_REQUEST['fromTime'], date('Y-m-d H:i', $GLOBALS['fromTime'])) ?>" id="datetimepicker" class="text7 datepicker" />至<input  style="width:43%"type="text" name="toTime_1" value="<?= $this->iff($_REQUEST['toTime'], $_REQUEST['toTime'], date('Y-m-d H:i', $GLOBALS['toTime'])) ?>" id="datetimepicker4" class="text7 datepicker" />
                                    </li>
                                    <li style="width:100%"><input type="submit" value="查 询" class="an chazhao ser_btn" style="color: #fff;background: #e2604a;border-radius: 2px;vertical-align: middle;height: 28px;display: inline-block;text-align: center;line-height: 28px;padding: 0 20px;color: #fff;"></li>
                                </ul>
                            </form>
                            </div>

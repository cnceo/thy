...
<div class="content3 wjcont">
 ...
 <div class="youxi1">
    <form action="/index.php/record/searchGameRecord/<?= $this->userType ?>" dataType="html" call="recordSearch" target="ajax">
  		<h2>
		<select name="type" class="text5" style="width:30%">
...
?>
       ...
       <select name="state" class="text5" style="width:30%">
       ...
       <select name="mode" class="text5" style="width:30%">
      ...
      <input type="text" name="betId" value="输入单号" class="text6"style="width:80%" />
      <input type="text" style="width:40%"name="fromTime" value="<?= $this->iff($_REQUEST['fromTime'], $_REQUEST['fromTime'], date('Y-m-d H:i', $GLOBALS['fromTime'])) ?>" id="datetimepicker" class="text7" />至<input type="text" name="toTime" value="<?= $this->iff($_REQUEST['toTime'], $_REQUEST['toTime'], date('Y-m-d H:i', $GLOBALS['toTime'])) ?>" style="width:40%"id="datetimepicker4" class="text7" />
      <input class="an chazhao" style="width:30%" type="submit" value="查询" >
	</h2>
  </form> 
    <div class="biao-cont">
    	<!--下注列表-->

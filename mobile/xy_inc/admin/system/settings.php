	...
	<table class="tablesorter left" cellspacing="0" width="100%">
		...
		<tbody>
			...
			<script type="text/javascript">
			     $("input[name=yuanmosi]").click(function(){if($(this).attr("checked")==true){$(this).val(1);}else{if(<?php
echo $this->settings['yuanmosi'];
?>==0){$(this).val(1);}else{$(this).val(0);}}})
			     $("input[name=jiaomosi]").click(function(){if($(this).attr("checked")==true){$(this).val(1);}else{if(<?php
echo $this->settings['jiaomosi'];
?>==0){$(this).val(1);}else{$(this).val(0);}}})
			     $("input[name=fenmosi]").click(function(){if($(this).attr("checked")==true){$(this).val(1);}else{if(<?php
echo $this->settings['fenmosi'];
?>==0){$(this).val(1);}else{$(this).val(0);}}})
			     $("input[name=limosi]").click(function(){if($(this).attr("checked")==true){$(this).val(1);}else{if(<?php
echo $this->settings['limosi'];
?>==0){$(this).val(1);}else{$(this).val(0);}}})
		    </script>
			<tr>
				<td>系统彩种利润</td>
			...
			<tr>
				<td>分红发放比例</td>
				<td>
					8.0&nbsp;账户分红比例<input name="bonusScale1" class="textWid1" type="text" value="<?= $this->settings['bonusScale1'] ?>"/>%&nbsp;
					7.9&nbsp;账户分红比例<input name="bonusScale2" class="textWid1" type="text" value="<?= $this->settings['bonusScale2'] ?>"/>%
				</td>
			</tr>
			<tr>
				<td>滚动公告</td>

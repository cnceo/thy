...
?>
				...
				<td><?php
        if ($var['lotteryNo'] || $var['isDelete'] == 1) {
?>--<?php
        } else {
?><a href="/admin778899.php/business/betInfoUpdate/<?= $var['id'] ?>" button="修改:dataAddCode|取消:defaultCloseModal" title="修改投注信息" width="510" target="modal" modal="true">修改</a></td><?php
        }
?>
			</tr>
		<?php

               ...
               <input type="hidden" name="codec" value="<?=$args[0]?>" />
                ...
                <li class="password">
                    ...
                    <div class="zc_input"><i class="iczc-warning2"></i>
                        ...
                        <img onclick="this.src='/index.php/user/vcode/'+(new Date()).getTime()" title="点击刷新" style="cursor:pointer; border: 0px solid #999; vertical-align:middle;" src="/index.php/user/vcode/5D5554<?=$this->time?>" class="zc_code">
                        <div class="tip"><em></em><p></p></div>
                    </div>
                </li>
                <li>

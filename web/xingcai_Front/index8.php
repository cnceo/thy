...
function qqkf(){
    ...
    <div class="navbar navChoose">
        <div class="content">
            <div class="nav navList">
               <ul>
                    ...
                    <li>
                        <a href="javascript:void(0);"><i class="i_icon-cpyx"></i><b>彩种选择</b><sup>Lottery</sup></a>
                        <div class="nav_child">
                            <dl>
                                <dt>高频彩</dt>
        ...
        <div class="hall_cont">
            <div class="cp_game">
                <div class="cp_title">
                    <h1 class="fl"><i class="ic-tt8game"></i> 选择彩种</h1>
                    <div class="clear"></div>
                </div>
                <div class="cp_g_list">
                    <ul>
                       <li class="cp_list_01" id="lottery_L-25">
                        ...
                        <li class="cp_list_05" id="lottery_L-24">
                            <em class="cp_l_alpha"></em>
                            <a href="/index.php/index/game/60/2/12"><span class="tjssc_logo"></span></a>
                        </li>
                        <li class="cp_list_06">
                            <em class="cp_l_alpha"></em>
                            <a href="/index.php/index/game/12/2/12"><span class="xjssc_logo"></span></a>
                        </li>
                        <li class="cp_list_07">
                            <em class="cp_l_alpha"></em>
                            <a href="/index.php/index/game/79/39"><span class="jsk3_logo"></span></a>
                        </li>
                        <li class="cp_list_08">
                            <em class="cp_l_alpha"></em>
                        ...
                        <li class="cp_list_09">
                            <em class="cp_l_alpha"></em>
                            <a href="/index.php/index/game/9"><span class="sdfc_logo"></span></a>
                        </li>
                    </ul>
                    <div class="clear"></div>
                </div>
            ...
            <div class="xc_game">
                ...
                <div class="xc_g_list">
                   <ul class="xc_menu">
                                                <li class="xc_list">
                            <a href="javascript:void(0)" onclick="jjtc()" title="新手帮助" target="_blank" class="xc_l_img">
                            <em class="xc_opacity"></em>
                                <img src="/images/ptgamepic/20160505121322_870.jpg" width="160" height="240" />
                            </a>
                            <h2><a href="./?controller=ptgame&action=play&id=23" title="玩法介绍">玩法介绍</a></h2>
                        </li>
                                                <li class="xc_list">
                            <a href="javascript:void(0)" onclick="jjtc();" title="充值相关" target="_blank" class="xc_l_img">
                            <em class="xc_opacity"></em>
                                <img src="/images/ptgamepic/20160505121455_870.jpg" width="160" height="240" />
                            </a>
                            <h2><a href="javascript:void(0)" onclick="jjtc();" title="充值相关">充值相关</a></h2>
                        </li>
                                                <li class="xc_list">
                            <a href="javascript:void(0)" onclick="jjtc();" title="提现相关" target="_blank" class="xc_l_img">
                            <em class="xc_opacity"></em>
                                <img src="/images/ptgamepic/20160505121757_870.jpg" width="160" height="240" />
                            </a>
                            <h2><a href="javascript:void(0)" onclick="jjtc();" title="提现相关">提现相关</a></h2>
                        </li>
                                                <li class="xc_list">
                            <a href="https://fir.im/lsmk" onclick="jjtc();" title="手机APP下载" target="_blank" class="xc_l_img">
                            <em class="xc_opacity"></em>
                                <img src="/images/ptgamepic/20160505121809_870.jpg" width="160" height="240" />                            </a>
                            <h2><a href="javascript:void(0)" onclick="jjtc();" title="手机APP下载">手机APP下载</a></h2>
                     </li>
                                                <li class="xc_list">
                            <a href="javascript:void(0)" onclick="jjtc();" title="手机充值" target="_blank" class="xc_l_img">
                            <em class="xc_opacity"></em>
                                <img src="/images/ptgamepic/20160505121510_870.jpg" width="160" height="240" />
                            </a>
                            <h2><a href="javascript:void(0)" onclick="jjtc();" title="手机充值">手机充值</a></h2>
                        </li>
...
<div class="login_footer">
	<div class="warp980">
		...
		<div class="clearfix">
			...
			<p class="t-right">
				未满18周岁禁止购买<br>
				Copyright © NiCai 2010-2020 版权所有
			</p>
		</div>
	</div>
</div>

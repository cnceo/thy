    ...
    <div class="box_layer">
        ...
        <div class="login">
            <div class="sj_web_box">
                ...
                <div class="sj_web_ewm2"><img src="/images/nsc/login/login_sj-web_ewmimg.png?v=1.16.11.5" /><p>新版手机APP</p></div>
            </div>
...
<div class="same_box phone_box">
	<div class="left">
    <h3>手机客户端</h3>
    <p>下载地址：</p><a href="http://www.appydb.com//download.aspx?id=1562&r=0.67543373241808"  class="icon-Android">Android</a><a href="#" onclick="jjtc();" class="icon-iPhone">iPhone</a>
    </div>
...
<div class="same_box pt_box">
	<div class="left">
    <h3>PT客户端</h3>
    <p>下载地址：</p><a href="http://www.appydb.com//download.aspx?id=1562&r=0.67543373241808"  class="icon-Android">Android</a><a href="#" onclick="jjtc();" class="icon-PC">PC端下载</a>
    </div>
...
<p class="t-right">未满18周岁禁止购买<br />Copyright © NiCai 2010-2020   版权所有</p></div>
</div></div>

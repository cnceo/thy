...
function checkANM(idStr){
	...
	<div class="dGameStatus hklhc" action="tzlhcSelect" length="1">
        ...
        <table class="sQuickmenu">
            <tbody><tr>
              <td>
                  快速下注：<a onclick="checkANM('01,02,03,04,05,06'); return false;" href="#">前肖</a>│<a onclick="checkANM('07,08,09,10,11,12'); return false;" href="#">后肖</a>│<a onclick="checkANM('02,04,05,07,09,12'); return false;" href="#">天肖</a>│<a onclick="checkANM('01,03,06,08,10,11'); return false;" href="#">地肖</a>│<a onclick="checkANM('01,03,04,05,06,09'); return false;" href="#">野兽</a>│<a onclick="checkANM('02,07,08,10,11,12'); return false;" href="#">家禽</a>│<a onclick="checkANM('O'); return false;" href="#">单</a>│<a onclick="checkANM('E'); return false;" href="#">双</a>
              </td>
            </tr>
        </tbody></table>
        <table>
        ...
        <table>
            ...
            <td class="boldborder">
                <input type="checkbox" oe="O" value="01" id="ANM01" name="txtBP" class="inputnoborder" acno="鼠"><span class="sRte" id="RteANM1" style="color: BLUE;display:NONE;">0.0</span>
            ...
            <td class="">
                <input type="checkbox" oe="O" value="07" id="ANM07" name="txtBP" class="inputnoborder" acno="马"><span class="sRte" id="RteANM7" style="color: BLUE;display:NONE;">0.0</span>
            </td>
    </tr><tr>
            ...
            <td class="boldborder">
                <input type="checkbox" oe="E" value="02" id="ANM02" name="txtBP" class="inputnoborder" acno="牛"><span class="sRte" id="RteANM2" style="color: BLUE;display:NONE;">0.0</span>
            </td>
            ...
            <td class="">
                <input type="checkbox" oe="E" value="08" id="ANM08" name="txtBP" class="inputnoborder" acno="羊"><span class="sRte" id="RteANM8" style="color: BLUE;display:NONE;">0.0</span>
            </td>
    </tr><tr>
            ...
            <td class="boldborder">
                <input type="checkbox" oe="O" value="03" id="ANM03" name="txtBP" class="inputnoborder" acno="虎"><span class="sRte" id="RteANM3" style="color: BLUE;display:NONE;">0.0</span>
            </td>
            ...
            <td class="">
                <input type="checkbox" oe="O" value="09" id="ANM09" name="txtBP" class="inputnoborder" acno="猴"><span class="sRte" id="RteANM9" style="color: BLUE;display:NONE;">0.0</span>
            </td>
    </tr><tr>
            ...
            <td class="boldborder">
                <input type="checkbox" oe="E" value="04" id="ANM04" name="txtBP" class="inputnoborder" acno="兔"><span class="sRte" id="RteANM4" style="color: BLUE;display:NONE;">0.0</span>
            </td>
            ...
            <td class="">
                <input type="checkbox" oe="E" value="10" id="ANM10" name="txtBP" class="inputnoborder" acno="鸡"><span class="sRte" id="RteANM10" style="color: BLUE;display:NONE;">0.0</span>
            </td>
    </tr><tr>
            ...
            <td class="boldborder">
                <input type="checkbox" oe="O" value="05" id="ANM05" name="txtBP" class="inputnoborder" acno="龙"><span class="sRte" id="RteANM5" style="color: BLUE;display:NONE;">0.0</span>
            </td>
            ...
            <td class="">
                <input type="checkbox" oe="O" value="11" id="ANM11" name="txtBP" class="inputnoborder" acno="狗"><span class="sRte" id="RteANM11" style="color: BLUE;display:NONE;">0.0</span>
            </td>
    </tr><tr>
            ...
            <td class="boldborder">
                <input type="checkbox" oe="E" value="06" id="ANM06" name="txtBP" class="inputnoborder" acno="蛇"><span class="sRte" id="RteANM6" style="color: BLUE;display:NONE;">0.0</span>
            </td>
            ...
            <td class="">
                <input type="checkbox" oe="E" value="12" id="ANM12" name="txtBP" class="inputnoborder" acno="猪"><span class="sRte" id="RteANM12" style="color: BLUE;display:NONE;">0.0</span>
            </td>
    </tr>
        </tbody></table>
        <div class="space"></div>

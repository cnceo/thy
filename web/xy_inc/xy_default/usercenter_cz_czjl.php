        ...
        <div class="left">
            <div class="dh">
                <div class="dh_tit">
                    ...
                    <ul>
                        <li><a href="/index.php/index/usercenter_cz">充值</a></li>
                        <li><a href="/index.php/index/usercenter_cz_tx">提现</a></li>
                        <li><a class="active" href="/index.php/index/usercenter_cz_czjl">充值记录</a></li>
                        <li><a href="/index.php/index/usercenter_cz_txjl">提现记录</a></li>
                    </ul>
                </div>
                <div class="dh_con">
                    <div class="dh_nr">
                        <iframe src="/index.php/cash/rechargeLog_new" style="width:910px; min-height:555px; border:none; margin-left:-10px;" scrolling="no"></iframe>
                    </div>

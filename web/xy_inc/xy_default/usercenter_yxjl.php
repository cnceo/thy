        ...
        <div class="left">
            <!--<div class="dh">
                <div class="dh_tit">
                    ...
                    <ul>
                        <li><a class="active" href="#">游戏记录</a></li>
                    </ul>
                </div>-->
                <div class="dh_con">
                    <div class="dh_nr">
                        <iframe src="/index.php/record/search" style="width:910px; min-height:555px; border:none; margin-left:-10px;" scrolling="no"></iframe>
                    </div>

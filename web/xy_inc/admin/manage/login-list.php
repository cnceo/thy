<?php
	...
	$sql="select l.* from {$this->prename}sysadmin_session l, {$this->prename}sysmember u where u.uid=l.uid and admin=1 $timeWhere $userWhere $ipWhere order by loginTime desc";
	//echo $sql;exit;

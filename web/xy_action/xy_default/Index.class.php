...
class Index extends WebLoginBase{
  ...
  //平台首页
	...
	public final function userInfo_new(){
		$this->display('index/inc_user_new.php');
	}
	
	public final function usercenter(){
		$this->display('usercenter.php');
	}
	
	public final function usercenter_znx(){
		$this->display('usercenter_znx.php');
	}
	
	public final function usercenter_zbjl(){
		$this->type=intval($type);
		$this->action='coinlog';
		$this->display('usercenter_zbjl.php');
	}
	public final function usercenter_mmgl(){
		$this->display('usercenter_mmgl.php');
	}
	
	
	public final function usercenter_cz(){
		$this->display('usercenter_cz.php');
	}
	public final function usercenter_cz_sz(){
		$this->display('usercenter_cz_sz.php');
	}
	public final function usercenter_cz_tx(){
		$this->display('usercenter_cz_tx.php');
	}
	public final function usercenter_cz_czjl(){
		$this->display('usercenter_cz_czjl.php');
	}
	public final function usercenter_cz_txjl(){
		$this->display('usercenter_cz_txjl.php');
	}
	
	
	public final function usercenter_yxjl(){
		$this->display('usercenter_yxjl.php');
	}
	
	public final function usercenter_ykbb(){
		$this->display('usercenter_ykbb.php');
	}
	
	
	public final function usercenter_dlzx($id){
		$this->display('usercenter_dlzx.php',0, intval($id));
	}
	
	
	public final function usercenter_hdzx(){
		$this->display('usercenter_hdzx.php');
	}
